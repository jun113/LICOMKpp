...
void kokkos_init_jra_daily_high() {
  ...
  if (CppParamMod::mytid == 0) {
    ...
    ViewDouble1D::HostMirror h_v_buffer = create_mirror_view(*p_v_buffer);
    // update s_lon s_lat
    read_jra(1, 365, "runoff_all.2016_daily.nc", h_v_buffer.data(), 
    ...
    read_jra(1, 365, "t_10.2016_daily.nc", h_v_t10.data());
    ...
    read_jra(1, 365, "u_10.2016_daily.nc", h_v_u10.data());
    ...
    read_jra(1, 365, "v_10.2016_daily.nc", h_v_v10.data());
    ...
    read_jra(1, 365, "slp.2016_daily.nc", h_v_slp.data());
    ...
    read_jra(1, 365, "q_10.2016_daily.nc", h_v_q10.data());
    ...
    read_jra(1, 365, "rsds.2016_daily.nc", h_v_swhf.data());
    ...
    read_jra(1, 365, "rlds.2016_daily.nc", h_v_lwhf.data());
    ...
    read_jra(1, 365, "rain.2016_daily.nc", h_v_precr.data());
    ...
    read_jra(1, 365, "snow.2016_daily.nc", h_v_precs.data());
    ...
    read_jra(1, 365, "ice.2016_daily.nc", h_v_si.data());
  ...
  if (CppParamMod::mytid == 0) {
    ...
    // update s_lon s_lat
    read_jra(1, 365, "runoff_all.2016_daily.nc", CppForcMod::buffer, 
